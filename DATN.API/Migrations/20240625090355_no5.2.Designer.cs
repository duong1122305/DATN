...
namespace DATN.API.Migrations
{
    ...
    [Migration("20240625090355_no5.2")]
    partial class no52
    {
        /// <inheritdoc />
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("DATN.Data.Entities.HistoryAction", b =>
                {
                    ...
                    b.Property<int>("ActionBookingID")
                        .HasColumnType("int");

                    b.Property<Guid>("ActionById")
                        .HasColumnType("uniqueidentifier");

                    b.Property<Guid?>("ActionByStaff")
                        .HasColumnType("uniqueidentifier");
            ...
            modelBuilder.Entity("DATN.Data.Entities.HistoryAction", b =>
                {
                    b.HasOne("DATN.Data.Entities.ActionBooking", "ActionBooking")
                        .WithMany("HistoryActions")
                        .HasForeignKey("ActionBookingID")
                        .OnDelete(DeleteBehavior.Cascade)
                        .IsRequired();
