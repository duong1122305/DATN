...
namespace DATN.API.Migrations
{
    ...
    [Migration("20240822163927_ver1.6.7")]
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("DATN.Data.Entities.Product", b =>
                {
                    ...
                    b.Property<int>("IdCategoryDeatail")
                        .HasColumnType("int");
            ...
            modelBuilder.Entity("DATN.ViewModels.DTOs.Booking.BookingView", b =>
                {
                    b.Property<string>("Address")
                        .IsRequired()
                        .HasColumnType("nvarchar(max)");
                    ...
                    b.Property<int>("CountBookingDetail")
                        .HasColumnType("int");
            ...
            modelBuilder.Entity("DATN.Data.Entities.Product", b =>
                {
                    ...
                    b.HasOne("DATN.Data.Entities.CategoryDetails", "CategoryDetails")
                        .WithMany("Products")
                        .HasForeignKey("IdCategoryDeatail")
                        .OnDelete(DeleteBehavior.Cascade)
                        .IsRequired();
